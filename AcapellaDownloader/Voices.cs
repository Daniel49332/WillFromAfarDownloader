    ...
    public static class Voices
    {
        ...
        static Voices()
        {
            VoiceList = new List<Voice>
            {
                ...
                new Voice("Zoe", Gender.Female, "nl_be", "zoe22k"),
                new Voice("Zoe (neural voice)", Gender.Female, "nl_be", "zoe_nt22k"),
                new Voice("Christinabtob (premium voice)", Gender.Female, "nl_be", "christinabtob22k"),
                new Voice("Christinabtob (neural premium voice)", Gender.Female, "nl_be", "christinabtob_nt22k"),
                new Voice("Jeroen", Gender.Male, "nl_be", "jeroen22k"),
                new Voice("Jeroen (neural voice)", Gender.Male, "nl_be", "jeroen_nt22k"),
                new Voice("Sofie", Gender.Female, "nl_be", "sofie22k"),
                new Voice("Sofie (neural voice)", Gender.Female, "nl_be", "sofie_nt22k"),
                ...
                new Voice("Manon-be", Gender.Female, "fr_be", "manon-be22k"),
                new Voice("Alice-be", Gender.Female, "fr_be", "alice-be22k"),
                new Voice("Anais-be", Gender.Female, "fr_be", "anais-be22k"),
                new Voice("Antoine-be", Gender.Male, "fr_be", "antoine-be22k"),
                new Voice("Bruno-be", Gender.Male, "fr_be", "bruno-be22k"),
                new Voice("Claire-be", Gender.Female, "fr_be", "claire-be22k"),
                new Voice("Julie-be", Gender.Female, "fr_be", "julie-be22k"),
                new Voice("Margaux-be", Gender.Female, "fr_be", "margaux-be22k"),
                ...
                new Voice("Minji", Gender.Female, "ko_kr", "minji22k"),
                ...
                new Voice("Marcia", Gender.Female, "pt_br", "marcia22k"),
                new Voice("Marcia (neural voice)", Gender.Female, "pt_br", "marcia_nt22k"),
                new Voice("Gabriela (premium voice)", Gender.Female, "pt_br", "gabriela22k"),
                new Voice("Gabriela (neural premium voice)", Gender.Female, "pt_br", "gabriela_nt22k"),
                ...
                new Voice("Elin", Gender.Female, "sv_se", "elin22k"),
                new Voice("Elin (neural voice)", Gender.Female, "sv", "elin_nt22k"),
                new Voice("Emil", Gender.Male, "sv_se", "emil22k"),
                new Voice("Emil (neural voice)", Gender.Male, "sv", "emil_nt22k"),
                new Voice("Emma", Gender.Female, "sv_se", "emma22k"),
                new Voice("Emma (neural voice)", Gender.Female, "sv", "emma_nt22k"),
                new Voice("Erik", Gender.Male, "sv_se", "erik22k"),
                new Voice("Erik (neural voice)", Gender.Male, "sv", "erik_nt22k"),
                new Voice("Samuel", Gender.Male, "sv_fi", "samuel22k"),
                new Voice("Samuel (neural voice)", Gender.Male, "sv_fi", "samuel_nt22k"),
                new Voice("Kal", Gender.Male, "sv_se", "kal22k"),
                new Voice("Kal (neural voice)", Gender.Male, "sv_se", "kal_nt22k"),
                ...
                new Voice("Vidhi", Gender.Female, "hi", "vidhi22k"),
                new Voice("Vidhi (neural voice)", Gender.Female, "hi", "vidhi_nt22k")
            };
        }
    }
}
